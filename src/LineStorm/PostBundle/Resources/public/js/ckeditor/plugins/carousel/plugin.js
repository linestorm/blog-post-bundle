    ...
    CKEDITOR.plugins.add('carousel', {
        ...
        init: function (editor) {
            ...
            var widget = {
                ...
                defaults: function () {
                    return {
                        carouselId: 'carousel-' + parseInt(Math.random(100000, 999999)*1000000),
                        slides: 3,
                        interval: 5000,
                        pause: 'hover',
                        wrap: "true",
                ...
                parts: {
                    ...
                    naviLeft: 'a.carousel-control-left',
                    naviRight: 'a.carousel-control-right'
                },
                template: '<div class="carousel slide" data-ride="carousel">' +
                    ...
                    '    </div>' +
                    '  </div>' +
                    '    <a class="left carousel-control carousel-control-left" href="#" data-slide="prev">' +
                    '        <span class="glyphicon glyphicon-chevron-left">&nbsp;</span>' +
                    '    </a>' +
                    '    <a class="right carousel-control carousel-control-right" href="#" data-slide="next">' +
                ...
                data: function () {
                    for (var i = 1; i <= maxSlides; i++) {
                        ...
                        if(this.element.getId()){
                            this.parts.naviLeft.setAttribute('href', '#' + this.element.getId());
                            this.parts.naviRight.setAttribute('href', '#' + this.element.getId());
                        }
                    }
                }
            };
