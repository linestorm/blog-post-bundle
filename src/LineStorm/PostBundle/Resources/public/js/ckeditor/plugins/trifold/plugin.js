CKEDITOR.plugins.add('trifold', {
    ...
    init: function (editor) {
        ...
        editor.ui.addButton('Trifold', {
            label: 'Create a trifold',
            command: 'trifold',
            toolbar: 'bootstrap,2'
        });

        editor.widgets.add('trifold', {
            allowedContent: 'div(!trifold,align-left,align-right,align-center){width};' +
            ...
            template: '<div class="row trifold text-center">' +
                '  <div class="col-md-4">' +
